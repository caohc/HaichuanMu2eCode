...
namespace mu2e{
  ...
  public:
    ...
    struct Config
    {
      fhicl::Atom<art::InputTag> stepPointMCsTag{Name("RelationStepPointMCsTag"), Comment("Input tag of StepPointMCs associated with VD10 and VD101")};
